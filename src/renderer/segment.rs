...
impl SegmentVertex {
    ...
    pub const SEGMENT_BYTE_SIZE: usize = Self::VERTICES_PER_SEGMENT * Self::BYTE_SIZE;
    ...
    pub fn new(segment: Segment2f, color: Color, pixel_width: PositiveF32) -> [Self; Self::VERTICES_PER_SEGMENT] {
